...
const MentorDetailContainer: React.FC<Profile> = ({
  username,
  gender,
  admissionYear,
  major,
    ...
    <div className="min-w-[352px] min-h-[478px] bg-[#FBFDFF] mr-[31px] relative rounded-[7px] shadow-md">
      ...
      <div className="mt-[20px] ml-[16px] w-[320px] h-[248px]">
        ...
        <div className="mt-[20px] flex justify-center items-center space-x-4">
          <button className="box-border flex justify-center items-center gap-2 w-20 h-8 bg-[#7C6DD1] border-2 border-[#7C6DD1] rounded-full">
